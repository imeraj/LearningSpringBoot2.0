...
import com.meraj.microservices.chat.handler.UserParsingHandshakeHandler;
import com.meraj.microservices.chat.stream.ChatServiceStreams;
...
public class InboundChatService extends UserParsingHandshakeHandler {
    ...
    InboundChatService(ChatServiceStreams chatServiceStreams) {
